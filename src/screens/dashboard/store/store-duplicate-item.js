...
import RadioOptionLi from "./../../../assets/icons/radio-option-li.png";
import { useForm } from "react-hook-form";
import $ from "jquery";
import PostLoginGetApi from '../../../components/api/PostLoginGetApi';
import { useParams } from 'react-router-dom';

const StoreDuplicateItem = () => {
    ...
    useEffect(() => {
        ...
        // PostLoginGetApi(`${previousData.image}`).then((responseJSON) => {


        //     // setImage(responseJSON.data.data);
        ...
        if (is_valid === true) {
            ...
            PostLoginPostApi("shop/item", reqBody, 1, 1).then((responseJSON) => {
                ...
                if (response["status"] === 1) {
                    ...
                    if (responseData["code"] === 200) {
                        toast.success("Item successfully duplicated.");
    ...
    //     if (event.key === 'Enter') {
    //         const copyCart = [...addons];
    //         copyCart.push(variant);
    //         setAddons(copyCart);
    //         setVariant("");
    //     }
    // }
                ...
                <div className="font-medium min-h-[100vh] w-[100%] h-[100%] custom-container-left custom-scroll-auto">
                    <form className="mb-10" action='' autoComplete="on" method='POST' encType='multipart/form-data' >
                        <header className="flex justify-between items-center p-4 border-b-2 border-dark-white mb-[60px]">
                            ...
                            <p className="-mr-24 text-xl text-black">Duplicate Item</p>
                            <div>
                        ...
                        <main className="max-w-2xl m-auto">
                            ...
                            <div className='block border border-[#e5e7eb] rounded-md py-5 px-4 mt-2 mb-5'>
                                ...
                                {previousData.low_stock_alert > 0 && <div id='low_stock_alert_div'>
                                    <div className="relative mt-2 pb-1 pt-1 mb-1">
...
export default StoreDuplicateItem;