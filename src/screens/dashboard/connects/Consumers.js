...
const Consumers = ({ currentTab, props = '' }) => {
    ...
    useEffect(() => {
        //  Get Consumer list
        PostLoginGetApi("shop/connect", { filter: "consumer", ...reqParam }).then((responseJSON) => {
            ...
            if (response["status"] === 1) {
                ...
                if (responseData["code"] === 200) {
                    ...
                    setConsumerList(responseData["data"]?.data);
                }
            }
        }).catch((err) => {
            console.log(err);
